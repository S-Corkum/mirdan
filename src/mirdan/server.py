...
@mcp.tool()
async def verify_plan(plan_path: str) -> dict[str, Any]:
    """
    Verify a flat implementation plan is internally executable — mechanical,
    local, deterministic, no LLM. Checks that every step's File exists (or, for
